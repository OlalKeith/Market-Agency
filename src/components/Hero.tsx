...
const Hero = () => {
  return (
    <section className="relative flex items-center justify-center h-screen text-white mx-auto container px-4">
      ...
      {/* Category Bar */}
      <div
        className="absolute transform -translate-x-1/2 left-1/2 mb-12 w-11/12 md:w-10/12 bg-purple-600 text-white p-2 md:p-4"
        style={{ bottom: "-4rem" }}
      >
        <div
          className="flex flex-wrap md:flex-nowrap justify-around items-center gap-3 md:gap-4"
          style={{ fontFamily: "'Playfair Display', serif" }}
        >
