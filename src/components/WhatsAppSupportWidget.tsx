        ...
        <div className="bg-white rounded-lg shadow-2xl w-80 mb-4 overflow-hidden border border-gray-200">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              {/* Company Logo/Avatar - Replace with your actual logo */}
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <img 
                  ...
                  onError={(e) => {
                    // Fallback to initials if logo doesn't load
                    (e.target as HTMLImageElement).style.display = 'none';
                    (e.target as HTMLImageElement).nextElementSibling!.style.display = 'flex';
                  }}
                />
                {/* Option 2: Fallback to company initials */}
                <div className="w-8 h-8 bg-purple-600 text-white rounded-full flex items-center justify-center text-xs font-bold hidden">
                  ATL
                </div>
              </div>
              <div className="min-w-0 flex-1">
                <h3 className="font-semibold text-xs truncate">{companyName}</h3>
